defmodule QMI.Codec.NetworkAccessTest do
  ...
  test "get sys info" do
    request = NetworkAccess.get_sys_info()

    assert IO.iodata_to_binary(request.payload) == <<0x4D, 0, 0, 0>>
    assert request.service_id == 0x03

    assert request.decode.(
             <<0x4D, 0x0, 0x88, 0x0, 0x2, 0x4, 0x0, 0x0, 0x0, 0x0, 0x0, 0x13, 0x3, 0x0, 0x0, 0x0,
               0x0, 0x14, 0x3, 0x0, 0x2, 0x2, 0x0, 0x19, 0x1D, 0x0, 0x1, 0x3, 0x1, 0x3, 0x1, 0x1,
               0x1, 0x0, 0x0, 0xFF, 0xFF, 0x1, 0xA, 0x77, 0x1B, 0x1, 0x0, 0x0, 0x0, 0x1, 0x33,
               0x31, 0x30, 0x34, 0x31, 0x30, 0x1, 0xA, 0x12, 0x1E, 0x2, 0x0, 0xFF, 0xFF, 0x21,
               0x1, 0x0, 0x0, 0x26, 0x1, 0x0, 0x0, 0x27, 0x4, 0x0, 0x1, 0x0, 0x0, 0x0, 0x29, 0x1,
               0x0, 0x1, 0x2A, 0x4, 0x0, 0x0, 0x0, 0x0, 0x0, 0x2F, 0x4, 0x0, 0x0, 0x0, 0x0, 0x0,
               0x31, 0x4, 0x0, 0x0, 0x0, 0x0, 0x0, 0x34, 0x2, 0x0, 0xFF, 0xFF, 0x38, 0x4, 0x0,
               0x3, 0x0, 0x0, 0x0, 0x39, 0x4, 0x0, 0x1, 0x0, 0x0, 0x0, 0x3E, 0x4, 0x0, 0x0, 0x0,
               0x0, 0x0, 0x44, 0x4, 0x0, 0x3, 0x0, 0x0, 0x0, 0x46, 0x4, 0x0, 0x4, 0x0, 0x0, 0x0>>
           ) ==
             {:ok,
              %{
                geo_sys_idx: 65_535,
                sim_rej_info: :available,
                lte_voice_status: :no_voice,
                srv_reg_restriction: :unrestricted,
                lte_reg_domain: :not_applicable,
                lte_sms_status: :"3GPP",
                lte_cell_status: :all_calls,
                embms_coverage_status: :unknown,
                voice_support_on_lte: false,
                lte_ims_voice_avail: true,
                lte_embms_coverage_trace_id: -1,
                lte_is_eb_supported: true,
                emergency_access_barred: false,
                lte_sys_info: %{
                  mcc: "310",
                  mnc: "410",
                  cell_id: 18_577_162,
  ...
  test "get_sys_info mcc/mnc invalid ascii" do
    request = NetworkAccess.get_sys_info()
    ...
    assert request.decode.(
             <<0x4D, 0x0, 0x88, 0x0, 0x2, 0x4, 0x0, 0x0, 0x0, 0x0, 0x0, 0x13, 0x3, 0x0, 0x0, 0x0,
               0x0, 0x14, 0x3, 0x0, 0x2, 0x2, 0x0, 0x19, 0x1D, 0x0, 0x1, 0x3, 0x1, 0x3, 0x1, 0x1,
               0x1, 0x0, 0x0, 0xFF, 0xFF, 0x1, 0xA, 0x77, 0x1B, 0x1, 0x0, 0x0, 0x0, 0x1, 0x32,
               0x31, 0x34, 0x30, 0x37, 0xFF, 0x1, 0xA, 0x12, 0x1E, 0x2, 0x0, 0xFF, 0xFF, 0x21,
               0x1, 0x0, 0x0, 0x26, 0x1, 0x0, 0x0, 0x27, 0x4, 0x0, 0x1, 0x0, 0x0, 0x0, 0x29, 0x1,
               0x0, 0x1, 0x2A, 0x4, 0x0, 0x0, 0x0, 0x0, 0x0, 0x2F, 0x4, 0x0, 0x0, 0x0, 0x0, 0x0,
               0x31, 0x4, 0x0, 0x0, 0x0, 0x0, 0x0, 0x34, 0x2, 0x0, 0xFF, 0xFF, 0x38, 0x4, 0x0,
               0x3, 0x0, 0x0, 0x0, 0x39, 0x4, 0x0, 0x1, 0x0, 0x0, 0x0, 0x3E, 0x4, 0x0, 0x0, 0x0,
